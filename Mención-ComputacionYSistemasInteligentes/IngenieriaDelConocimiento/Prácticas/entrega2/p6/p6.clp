...
(deffacts palabras_clave_tipo_plato
    ...
    (palabra_clave desayuno-merienda "sandwich" "bocadillo" "tostada" "crepe" "tortitas" "croissant" "napolitana")
...
(defrule MAIN::mostrar-menu
    ...
    (switch ?opcion
        (case 1 then
            (printout t "Tipo de plato deseado (principal/entrante/postre/desayuno-merienda/acompanamiento/bebida/salsa/cualquiera): ")
            (bind ?v (read))
