...
bool AplicacionIG::seleccion( int x, int y ) 
{
   ...
   // Objeto3D* objeto_identificador = nullptr;
   // vec3 centro = vec3(0.0, 0.0, 0.0);
   // if(escena->objetoActual()->buscarObjeto(identificador, *new mat4(1.0f), &objeto_identificador, centro)){
   //    objeto_identificador->cuandoClick(centro);
   // }
