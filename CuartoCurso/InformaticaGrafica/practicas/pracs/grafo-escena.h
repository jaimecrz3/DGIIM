...
class NodoGrafoEscena : public Objeto3D
{
   ...
   bool centro_calculado = false; //true si se ha invocado al metodo calcularCentroOC
...
class BeethovenMadera : public NodoGrafoEscena
{
   public:
      BeethovenMadera(bool vetas_vertical);
};
