...
using namespace std;
/*
 * El generador de caso crea la matriz de conveniencias entre todos los invitados a sentar. Es una matriz donde todos
...
int main(int argc, char* argv[]) {
    ...
    */
	...
	if (argc != 2) {
        cerr << "Formato " << argv[0] << " <num_inivitados>" << endl;
        return -1;
    }
    
    int num_invitados = atoi(argv[1]);
    if (num_invitados <= 0) {
