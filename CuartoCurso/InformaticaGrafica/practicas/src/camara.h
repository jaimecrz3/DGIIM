...
class Camara
{
   ...
   glm::mat4 matriz_vista = glm::mat4(1.0) , // matriz de vista( creo),posiciona los puntos en su lugar en coordenads relatias a la camara
...
//modo examinar: util para visualizar objetos(el punto e atencion siemreesta fijo en el centro de la imagen)
//mod primera persna: util para exploracion de excenarios
//con rotaciones: se usan rotaciones entorno al origen de la camara Oec
//con traslaciones: se traslada el origen del marco de camara Oec y el punto deatencion At de forma solidaria
