...
(define (problem tierra-media-problema3d) ; Cabecera del problema y nombre
  (:domain tierra-media-ej3d) ; Nombre del dominio asociado al problema
  ...
  (:init ; Estado inicial
    ...
    ; Establecemos todas las relaciones de orden posibles entre los cuatro hobbits
    (idMenor Hobbit1 Hobbit2)
    (idMenor Hobbit1 Hobbit3)
    (idMenor Hobbit1 Hobbit4)
    (idMenor Hobbit2 Hobbit3)
    (idMenor Hobbit2 Hobbit4)
    (idMenor Hobbit3 Hobbit4)
    ...
    ; Capacidades de extracción heredadas
    ...
    ; Nodos de recursos del mapa de la Tierra Media
    ...
    ; El camino Rivendell-Moria se destruye tras ser transitado en cualquiera de los dos sentidos.
