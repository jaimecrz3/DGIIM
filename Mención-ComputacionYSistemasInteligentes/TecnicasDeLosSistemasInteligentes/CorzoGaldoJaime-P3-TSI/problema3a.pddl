...
(define (problem tierra-media-problema3a) ; Cabecera del problema y nombre
  (:domain tierra-media-ej3a) ; Nombre del dominio asociado al problema
  ...
  (:init ; Estado inicial
    ...
    ; Tipos narrativos de los personajes
